...
export default function AircraftCalendarScreen() {
    ...
    return (
        <ThemedView className="flex-1 px-4 pt-2">
            {/* Header */}
            <AircraftDetailsHeader header="Calendario" />

            <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                {/* Title Section Card */}
                <AircraftDetailsTitleCard title="Agenda mensual" model={model} registration={registration} />
                                            ...
                                            {cell !== null ? (
                                                <TouchableOpacity
                                                    onPress={() => {
                                                        ...
                                                        const dateStr = `${currentYear}-${monthStr}-${dayStr}`;
                                                        router.push({
                                                            pathname: "./calendar/day-schedule",
                                                            params: {
                                                                id,
