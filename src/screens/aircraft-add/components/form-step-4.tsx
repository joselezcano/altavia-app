...
import { AircraftSpecs, EmergencyRadioSchema, LifeJacketSchema, SurvivalEquipmentSchema } from "@/types/owner";
        ...
        <View className="bg-brand-white rounded-2xl p-5 border border-slate-100 shadow-sm gap-4 mb-4">
            ...
            {dinghiesCarried && (
                <View className="bg-white rounded-xl p-4 border border-slate-200 gap-3 mt-2">
                    ...
                    <View className="flex-row justify-between items-center bg-slate-50 border border-slate-200 rounded-lg px-3 py-3 mt-2 mb-1">
