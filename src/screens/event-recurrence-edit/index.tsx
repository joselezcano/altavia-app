...
import { DAYS_OF_WEEK, PERIOD_LABELS, REASON_OPTIONS, formatDateString, mapEnglishToUI, mapUIToEnglish, parseDateString } from "@/screens/event-recurrence";
...
export default function EventRecurrenceEditScreen() {
    ...
    return (
        ...
        >
            <ThemedView className="flex-1 px-4 pt-2">
                {/* Header */}
                <AircraftDetailsHeader header="Editar Indisponibilidad" />
