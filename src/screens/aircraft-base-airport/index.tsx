...
export default function BaseAirportScreen() {
        ...
        try {
            ...
            Toast.show({
                ...
                text2: selectedAirport
                    ? `${selectedAirport.name} (${selectedAirport.iata_code || selectedAirport.icao_code || ""
                    })`
    ...
    return (
        <ThemedView className="flex-1 px-4 pt-2">
            {/* Header */}
            <AircraftDetailsHeader header="Aeropuerto Base" />

            <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
                {/* Title Section Card */}
                <AircraftDetailsTitleCard title="Base de Operaciones" model={basic_specs.model} registration={basic_specs.registration} />
